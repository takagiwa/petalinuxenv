...
Vagrant.configure("2") do |config|
  ...
  # hostname
  config.vm.hostname = "xilinx2017-1"
  ...
  config.vm.provision "shell",
    env: {
      ...
      "VIVADO_FILENAME" => "Xilinx_Vivado_SDK_2017.1_0415_1",
      # Vitis/Vivado batch install configuration file name
      "CONFIG_FILENAME" => "batch_config/xilinxconfig_2017.1_webpack.txt",
      # Vitis/Vivado/Petalinux version name
      "VERSION_STR" => "2017.1",
      # Petalinux installer filename
      "PETALINUX_FILENAME" => "petalinux-v2017.1-final-installer.run"
