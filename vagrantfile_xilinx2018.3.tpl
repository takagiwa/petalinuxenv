# variables
# xilinxconfigfile (xilinxconfig_2018.3_webpack.txt|xilinxconfig_2018.3_design.txt|xilinxconfig_2018.3_system.txt)
...
echo '/mnt/iso/ubuntu-16.04.3-server-amd64.iso /mnt/dvdiso iso9660 loop,ro,auto,nofail 0 0' >> /etc/fstab
...
echo 'install Vivado'
cd /home/vagrant
tar zvxf /mnt/xilinxinstaller/Xilinx_Vivado_SDK_2018.3_1207_2324.tar.gz
chown -R vagrant:vagrant ./Xilinx_Vivado_SDK_2018.3_1207_2324
cd Xilinx_Vivado_SDK_2018.3_1207_2324
# choose configuration file
sudo ./xsetup --agree XilinxEULA,3rdPartyEULA,WebTalkTerms --batch Install --config /mnt/xilinxinstaller/xilinxconfig_2018.3_webpack.txt
cd ..
# rm -rf ./Xilinx_Vivado_SDK_2018.3_1207_2324

echo 'install Petalinux'
mkdir -p /home/vagrant/petalinux/2018.3
sudo chown -R vagrant:vagrant /home/vagrant/petalinux
sudo chmod +x /mnt/xilinxinstaller/petalinux-v2018.3-final-installer.run
# license agreement required
# Failed to install automatically. Need to install manually.
yes | sudo -u vagrant /mnt/xilinxinstaller/petalinux-v2018.3-final-installer.run /home/vagrant/petalinux/2018.3 > /dev/null 2>&1
source /home/vagrant/petalinux/2018.3/settings.sh
petalinux-util --webtalk off

echo 'source /opt/Xilinx/Vivado/2018.3/settings64.sh' >> /home/vagrant/.bash_profile
echo 'source /home/vagrant/petalinux/2018.3/settings.sh' >> /home/vagrant/.bash_profile
...
# https://www.xilinx.com/content/dam/xilinx/support/documents/sw_manuals/xilinx2018_3/ug973-vivado-release-notes-install-license.pdf
