...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell",
    env: {
      ...
      "VIVADO_FILENAME" => "Xilinx_Vivado_SDK_2017.4_1216_1",
      # Vitis/Vivado batch install configuration file name
      "CONFIG_FILENAME" => "batch_config/xilinxconfig_2017.3_webpack.txt",
      # Vitis/Vivado/Petalinux version name
      "VERSION_STR" => "2017.4",
      # Petalinux installer filename
      "PETALINUX_FILENAME" => "petalinux-v2017.4-final-installer.run"
