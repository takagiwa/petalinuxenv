...
Vagrant.configure("2") do |config|
  ...
  # hostname
  config.vm.hostname = "xilinx2021-1"
  ...
  config.vm.provision "shell",
    env: {
      ...
      "VIVADO_FILENAME" => "Xilinx_Unified_2021.1_0610_2318",
      # Vitis/Vivado batch install configuration file name
      "CONFIG_FILENAME" => "batch_config/xilinxconfig_2021.1_vitis.txt",
      # Vitis/Vivado/Petalinux version name
      "VERSION_STR" => "2021.1",
      # Petalinux installer filename
      "PETALINUX_FILENAME" => "petalinux-v2021.1-final-installer.run"
