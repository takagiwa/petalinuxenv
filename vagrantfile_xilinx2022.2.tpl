...
Vagrant.configure("2") do |config|
  ...
  # hostname
  config.vm.hostname = "xilinx2022-2"
  ...
  config.vm.provision "shell",
    env: {
      ...
      "VIVADO_FILENAME" => "Xilinx_Unified_2022.2_1014_8888",
      # Vitis/Vivado batch install configuration file name
      "CONFIG_FILENAME" => "batch_config/xilinxconfig_2022.2_vitis.txt",
      # Vitis/Vivado/Petalinux version name
      "VERSION_STR" => "2022.2",
      # Petalinux installer filename
      "PETALINUX_FILENAME" => "petalinux-v2022.2-10141622-installer.run"
