...
yes | sudo -u vagrant /mnt/xilinxinstaller/petalinux-v2017.3-final-installer.run /home/vagrant/petalinux/2017.3
...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder ".\\work", "/home/vagrant/work", create: true, mount_options: ["dmode=755", "fmode=755"]
